...
def student_numberSort(alist, start, end):
    if end-start > 1:
        mid = (start+end)//2
        student_numberSort(alist,start,mid)
        student_numberSort(alist, mid, end)
...
# userInput = int(input("Enter Number Of Students : "))
# alist = [input(f"Enter {_} Student RollNumbers: ") for _ in range(1, userInput+1)]
# student_numberSort(alist, 0, len(alist))
# print("Sorted list is: ", alist)

userInput = int(input("Enter Number Of Students : "))
alist = [int(input(f"Enter {_} Student RollNumbers: ")) for _ in range(1, userInput+1)]
student_numberSort(alist, 0, len(alist))
print("Sorted list is: ", alist)